...
router
    ...
    .post(rateLimiter, authMiddleware, canAccessProject, taskValidator(), validate, createTask)
    .get(rateLimiter, authMiddleware, canAccessProject, getProjectTasks)
    .get(rateLimiter, authMiddleware, canAccessProject, canAccessTask, getUserTasks);
router
    .route("/projects/:projectId/tasks/:taskId")
    .get(rateLimiter, authMiddleware, canAccessProject, canAccessTask, getTask)
    .patch(rateLimiter, authMiddleware, canAccessProject, canAccessTask, taskValidator(), validate, updateTask)
    .delete(rateLimiter, authMiddleware, canAccessProject, canAccessTask, deleteTask);
router
    .route("/projects/:projectId/tasks/:taskId/status")
    .patch(rateLimiter, authMiddleware, canAccessProject, canAccessTask, changeTaskStatus);
