...
router
    .route("/projects")
    .post(rateLimiter, authMiddleware, projectValidator(), validate, createProject)
...
router
    ...
    .patch(rateLimiter, authMiddleware, canAccessProject, projectValidator(), validate, updateProject)
...
router
    ...
    .delete(rateLimiter, authMiddleware, canAccessProject, removeMemberFromProject);
